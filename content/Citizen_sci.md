...
date: Friday Apr 23, 2021 18:44:32 +08
author: Amanda Lee
header-includes: |
	\usepackage{enumitem}
	\setlistdepth{20}
...
Citizen science is a popularised term that describes a family of different participatory modes in which amateurs, without necessarily a formal training in science, contribute to the production of scientific knowledge (“with education as an associated goal or a by-product”). [3] Further, there are different types of citizen science such as simple data gathering to extreme forms of citizen science which may include self-experimentation. [4] 

In today’s post, I would like to discuss how around the globe, the vegetarianism and vegan movement has become more popular. Many individuals are leaning towards plant-based diets due to general health reasons, stemming from concerns over health risk from consuming meat, as well as environmental reasons such as a concern with the environmental degradation associated with the meat industry. In this entry, we focus on vegetarian’s concerns about health, as that is the interface between food science and social actors.
...
<input type="checkbox" id="mn-note" class="margin-toggle"/>
<span class="marginnote">
Source: [https://www.travellingmcds.com/2017/05/veggie-crunch-burger-singapore-april.html]( https://www.travellingmcds.com/2017/05/veggie-crunch-burger-singapore-april.html)
</span>
...
<input type="checkbox" id="mn-note" class="margin-toggle"/>
<span class="marginnote">
Source: [https://www.facebook.com/BurgerKingSG/photos/a.403938841773/10157092437906774/?type=3&theater](https://www.facebook.com/BurgerKingSG/photos/a.403938841773/10157092437906774/?type=3&theater)
</span>

Furthermore, food chains such as Impossible Food have started researching plant-based meat for vegans to experience meat-like taste. This is made possible by an advancing food science with more interests in vegetarianism as a legitimate issue of science and increased funding from societal interest. 

<label for="mn-note" class="margin-toggle">
<img src="{static}/images/impossible_fd.png" width="200" height="200" />
</label>
<input type="checkbox" id="mn-note" class="margin-toggle"/>
<span class="marginnote">
Source: [https://www.impossiblefoods.com/](https://www.impossiblefoods.com/)
</span>

Plant-based Meat making process video

<iframe width="560" height="315" src="https://www.youtube.com/embed/6fGEggkj02g" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>

## Findings
The scientific research on the risk of processed/red meat led to a change in food preference among the citizens to form a vegan movement. It is interesting then, that the shift into vegetarianism out of a concern for red meat, has led to McDonald’s or Burger King’s coalition with vegetarianism, since these processed foods are clearly just as unhealthy, and eating a McDonald’s veggie burger is more of a social signal than a good nutritional source.  
